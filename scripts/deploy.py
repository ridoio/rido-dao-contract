...
def main():
    ...
    rido = project.ERC20SRIDO.deploy("RIDO Integral","RIDO-I",18,miner,10_000_000_000 *10 ** 18,10_000_000_000 *10 ** 18,sender=account)
    ...
    # print(dataPools.set_data_pools(data_pool,1,2,8,100 * 10 ** 18,1,sender=account))
